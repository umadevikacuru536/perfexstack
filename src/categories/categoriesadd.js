                                    ...
                                    <div class="row">
                                        ...
                                        <form>
                                            <div class="col-md-7">
                                                ...
                                                <br />
                                                <input className="input" placeholder="select category" onChange={(e) => setname(e.target.value)}
                                                    value={name} />
                                                ...
                                                <div className='dropdown dropend'>
                                                    <select onChange={(e) => settag(e.target.value)} className="left-align-select">
                                                ...
                                                <select onChange={(e) => setaccessplan(e.target.value)}>
