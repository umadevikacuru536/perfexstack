            ...
            <div className="row">
              <div className="col-md-12">
                <div className="card213 text-start">
                  ...
                  {selectedQuestionType === 'fill' && <FilllMarkingForm  />}
                  {selectedQuestionType === 'trueFalse' && < TrueFalseForm  />}
                  {selectedQuestionType === 'writing' && <WritingForm  />}
                  {selectedQuestionType === 'speaking' && <SpeakingForm/>}
                </div>
              </div>
            </div>
          </div>
...
<button className="create"> Create</button>
  ...
  const MultiOptionForm = () => {
    return (
      <div>
      {/* Render the form for single correct option questions */}
     <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}>  Multi Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
      {/* Add the form fields for single option questions */}
      <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
      <select className="qustionselection">
          <option></option>
...
<button className="create"> Create</button>
  ...
  const PartialMarkingForm = () => {
    return (
      <div>
      {/* Render the form for single correct option questions */}
     <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}> Partial Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
      {/* Add the form fields for single option questions */}
      <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
      <select className="qustionselection">
          <option></option>
...
<button className="create"> Create</button>
  ...
  const FilllMarkingForm = () => {
    return (
      <div>
        {/* Render the form for single correct option questions */}
       <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}> Filll Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
        {/* Add the form fields for single option questions */}
        <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
        <select className="qustionselection">
            <option></option>
...
<button className="create"> Create</button>
  ...
  const TrueFalseForm = () => {
    return (
      <div>
        {/* Render the form for single correct option questions */}
       <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}> TrueFalse Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
        {/* Add the form fields for single option questions */}
        <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
        <select className="qustionselection">
            <option></option>
...
<button className="create"> Create</button>
  ...
  const WritingForm = () => {
    return (
      <div>
        {/* Render the form for single correct option questions */}
       <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}> Writing Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
        {/* Add the form fields for single option questions */}
        <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
        <select className="qustionselection">
            <option></option>
...
<button className="create"> Create</button>
  ...
  const SpeakingForm = () => {
    return (
      <div>
        {/* Render the form for single correct option questions */}
       <p>Note:<span style={{fontSize:"17px",fontWeight:"bold"}}> Speaking Option Question </span>will have a minumum of 3 options and a maximum of 5 options One of the option will be the correct answer for this type of Question</p>
        {/* Add the form fields for single option questions */}
        <label className="qustionlabel">Subject<span className="star">*</span></label><br/>
        <select className="qustionselection">
            <option></option>
