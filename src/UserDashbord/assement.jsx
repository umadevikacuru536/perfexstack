    ...
    return (
        <div>
            ...
            <div >
                ...
                <button className="col-12 col-md-12 col-lg-3 assementbtn" onClick={() => handleCategoryClick('App Development')}>App Development</button>
            </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    {selectedCategory === 'All' || selectedCategory === 'Programming' ? (
                        <div className="col-sm-12 col-md-4 col-lg-3 mx-3  assementcard">
                    ...
                    {selectedCategory === 'All' || selectedCategory === 'App Development' ? (
                        <div className="col-sm-12 col-md-4 col-lg-3 mx-3 assementcard">
                            <div className="d-flex flex-row m-2">
                                <p className="program">Programing</p>
                                <p className="program1">Free</p>
