...
import { faBars, faHome, faUser, faEnvelope, faInfo, faCog, faLock, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
function Sidebar() {
      ...
      <nav className={isActive ? 'active' : ''}>
        <ul>
          ...
          <li>
            <a href="#">
            <span class="material-symbols-outlined icon">group</span>
              <span className="title">Assigned Assessments</span>
            </a>
          </li>
          <li>
            <a href="#">
